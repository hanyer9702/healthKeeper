...
<%@ include file="/WEB-INF/views/common/include/head.jsp"%>
	...
	<!-- App favicon -->
    <link rel="shortcut icon" href="/resources/chat/assets/images/favicon.ico" id="tabIcon">

    <!-- glightbox css -->
    <link rel="stylesheet" href="/resources/chat/assets/libs/glightbox/css/glightbox.min.css">

    <!-- One of the following themes -->
    <link rel="stylesheet" href="/resources/chat/assets/libs/@simonwep/pickr/themes/nano.min.css" /> <!-- 'classic' theme -->

    <!-- swiper css -->
    <link rel="stylesheet" href="/resources/chat/assets/libs/swiper/swiper-bundle.min.css">

    <!-- Bootstrap Css -->
    <link href="/resources/chat/assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="/resources/chat/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="/resources/chat/assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
...
<body>
	            ...
	            <ul class="nav nav-pills side-menu-nav" role="tablist">
	                ...
	                <li class="nav-item dropdown profile-user-dropdown">
	                    <a class="nav-link dropdown-toggle bg-light" href="#" role="button" data-bs-toggle="dropdown"
	                        ...
	                        <img src="/resources/chat/assets/images/users/avatar-1.jpg" alt="" class="profile-user rounded-circle">
	                    </a>
	    ...
	    <div class="chat-leftsidebar">
	        ...
	        <div class="tab-content">
	            ...
	            <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
	                ...
	                <div>
	                    <div class="user-profile-img">
	                        <img src="/resources/chat/assets/images/4902908.jpg" class="profile-img" style="height: 160px;" alt="">
	                    ...
	                    <div class="text-center border-bottom border-bottom-dashed pt-2 pb-4 mt-n5 position-relative">
	                        <div class="mb-lg-3 mb-2">
	                            <img src="/resources/chat/assets/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
	                        </div>
	                        ...
	                        <div class="border-bottom border-bottom-dashed mb-4 pb-4">
	                            ...
	                            <div class="profile-media-img">
	                                <div class="media-img-list">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-1.jpg" alt="media img" class="img-fluid">
	                                    </a>
	                                </div>
	                                <div class="media-img-list">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-2.jpg" alt="media img" class="img-fluid">
	                                    </a>
	                                </div>
	                                <div class="media-img-list">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-4.jpg" alt="media img" class="img-fluid">
	                        ...
	                        <div>
	                            ...
	                            <div>
	                                <div class="card p-2 border border-dashed mb-2">
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0 ms-1 me-3">
	                                            <img src="/resources/chat/assets/images/pdf-file.png" alt="" class="avatar-xs">
	                                        </div>
	                                ...
	                                <div class="card p-2 border border-dashed mb-2">
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0 ms-1 me-3">
	                                            <img src="/resources/chat/assets/images/image-file.png" alt="" class="avatar-xs">
	                                        </div>
	                                        <div class="flex-grow-1 overflow-hidden">
	                                ...
	                                <div class="card p-2 border border-dashed mb-0">
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0 ms-1 me-3">
	                                            <img src="/resources/chat/assets/images/zip-file.png" alt="" class="avatar-xs">
	                                        </div>
	                                        <div class="flex-grow-1 overflow-hidden">
	                    ...
	                    <div class="chat-message-list chat-bookmark-list" id="chat-bookmark-list" data-simplebar>
	                        <ul class="list-unstyled chat-list">
	                            ...
	                            <li>
	                                <div class="d-flex align-items-center">
	                                    <div class="flex-shrink-0 ms-1 me-3">
	                                        <img src="/resources/chat/assets/images/link-file.png" alt="" class="avatar-xs">
	                                    </div>
	                                    <div class="flex-grow-1 overflow-hidden">
	                            ...
	                            <li>
	                                <div class="d-flex align-items-center">
	                                    <div class="flex-shrink-0 ms-1 me-3">
	                                        <img src="/resources/chat/assets/images/txt-file.png" alt="" class="avatar-xs">
	                                    </div>
	                                    <div class="flex-grow-1 overflow-hidden">
	            ...
	            <div class="tab-pane" id="pills-setting" role="tabpanel" aria-labelledby="pills-setting-tab">
	                ...
	                <div>
	                    <div class="user-profile-img">
	                        <img src="/resources/chat/assets/images/small/img-4.jpg" class="profile-img profile-foreground-img" style="height: 160px;"
	                            alt="">
	                        <div class="overlay-content">
	                            <div>
	                    ...
	                    <div class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
	                        <div class="mb-3 profile-user">
	                            <img src="/resources/chat/assets/images/users/avatar-1.jpg"
	        ...
	        <div class="chat-content d-lg-flex">
	                                    ...
	                                    <div class="flex-grow-1 overflow-hidden">
	                                        <div class="d-flex align-items-center">
	                                            <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
	                                                <img src="/resources/chat/assets/images/users/avatar-2.jpg" class="rounded-circle avatar-sm" alt="">
	                        ...
	                        <!-- <div class="chat-list left" id="10">
	                            <div class="conversation-list">
	                                <div class="chat-avatar">
	                                    <img src="/resources/chat/assets/images/users/avatar-2.jpg" alt="">
	                                </div>
	                                                ...
	                                                <div class="message-img-link">
	                                                    <ul class="list-inline mb-0">
	                                                        <li class="list-inline-item dropdown">
	                                                            ...
	                                                            <div class="dropdown-menu">
	                                                                <a class="dropdown-item d-flex align-items-center justify-content-between"
	                                                                    href="/resources/chat/assets/images/small/img-1.jpg" download="">
	                                    ...
	                                    <div class="flex-grow-1 overflow-hidden">
	                                        <div class="d-flex align-items-center">
	                                            <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3">
	                                                <img src="/resources/chat/assets/images/users/user-dummy-img.jpg" class="rounded-circle avatar-sm"
	                                                    alt="">
	                                            </div>
	                                            <div class="flex-grow-1 overflow-hidden">
	                                                <h6 class="text-truncate mb-0 fs-18"><a href="#"
	            ...
	            <div class="user-profile-sidebar">
	                ...
	                <div class="p-3 border-bottom">
	                    <div class="user-profile-img">
	                        <img src="/resources/chat/assets/images/users/avatar-2.jpg" class="profile-img rounded" alt="">
	                        ...
	                        <ul class="list-unstyled chat-list mx-n4">
	                            <li>
	                                <a href="javascript: void(0);">
	                                    <div class="d-flex align-items-center">
	                                        <img src="/resources/chat/assets/images/users/group-img.jpg" alt="" class="avatar-sm rounded-circle me-3">
	                                        <div class="flex-grow-1 overflow-hidden">
	                        ...
	                        <div class="profile-media-img">
	                            <div class="row g-1">
	                                <div class="col-lg-4 col-6">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-1.jpg" alt="media img" class="img-fluid rounded">
	                                    </a>
	                                </div>
	                                <div class="col-lg-4 col-6">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-2.jpg" alt="media img" class="img-fluid rounded">
	                                    </a>
	                                </div>
	                                <div class="col-lg-4 col-6">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-3.jpg" alt="media img" class="img-fluid rounded">
	                                    </a>
	                                </div>
	                                <div class="col-lg-4 col-6">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-4.jpg" alt="media img" class="img-fluid rounded">
	                                    </a>
	                                </div>
	                                <div class="col-lg-4 col-6">
	                                    <a href="#">
	                                        <img src="/resources/chat/assets/images/small/img-5.jpg" alt="media img" class="img-fluid rounded">
	                                    </a>
	                                </div>
	                                <div class="col-lg-4 col-6">
	                                    <div class="position-relative rounded overflow-hidden">
	                                        <a href="javascript:void(0);" class="d-block">
	                                            <img src="/resources/chat/assets/images/small/img-6.jpg" alt="media img" class="img-fluid rounded">
	                ...
	                <div class="modal-body p-0">
	                    <div class="text-center p-4 pb-0">
	                        ...
	                        <div class="avatar-xl mx-auto mb-4">
	                            <img src="/resources/chat/assets/images/users/avatar-7.jpg" alt="" class="img-thumbnail rounded-circle">
	                        </div>
	                        <div>
	        ...
	        <div class="modal-dialog modal-dialog-centered">
	            <div class="modal-content border-0">
	                <div class="modal-body p-0">
	                    ...
	                    <img src="/resources/chat/assets/images/users/avatar-2.jpg" alt="" class="videocallModal-bg">
	                    <div>
	                        <img src="/resources/chat/assets/images/users/avatar-1.jpg" alt="" class="avatar-lg video-call-profile rounded">
	                    </div>
	        ...
	        <div class="modal-dialog modal-dialog-centered">
	            <div class="modal-content border-0">
	                <div class="modal-body p-0 overflow-hidden">
	                    ...
	                    <img src="/resources/chat/assets/images/users/avatar-7.jpg" alt="" class="videocallModal-bg rounded" />
	                    <ul class="list-unstyled groud-call-user vstack gap-3 position-absolute end-0 top-0 p-3">
	                        <li>
	                            <a href="javascript:void(0);"><img src="/resources/chat/assets/images/users/avatar-11.jpg" alt=""
	                                    class="avatar-lg rounded"></a>
	                        </li>
	                        <li>
	                            <a href="javascript:void(0);"><img src="/resources/chat/assets/images/users/avatar-6.jpg" alt=""
	                                    class="avatar-lg rounded" /></a>
	                        </li>
	                        <li>
	                            <a href="javascript:void(0);"><img src="/resources/chat/assets/images/users/avatar-3.jpg" alt=""
	                                    class="avatar-lg rounded" /></a>
	                        </li>
	                    </ul>
	                        ...
	                        <div>
	                            ...
	                            <ul class="list-unstyled contact-list mb-0">
	                                ...
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-10.jpg" alt=""
	                        ...
	                        <div class="mt-2">
	                            ...
	                            <ul class="list-unstyled contact-list mb-0">
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-4.jpg" alt=""
	                                                class="avatar-sm rounded-circle">
	                                        </div>
	                                ...
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-8.jpg" alt=""
	                                                class="avatar-sm rounded-circle">
	                                        </div>
	                        ...
	                        <div class="mt-2">
	                            ...
	                            <ul class="list-unstyled contact-list mb-0">
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-12.jpg" alt=""
	                                                class="avatar-sm rounded-circle">
	                                        </div>
	                        ...
	                        <div class="mt-2">
	                            ...
	                            <ul class="list-unstyled contact-list mb-0">
	                                ...
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-3.jpg" alt=""
	                                                class="avatar-sm rounded-circle">
	                                        </div>
	                        ...
	                        <div class="mt-2">
	                            ...
	                            <ul class="list-unstyled contact-list">
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-6.jpg" alt=""
	                                                class="avatar-sm rounded-circle">
	                                        </div>
	                        ...
	                        <div class="mt-2">
	                            ...
	                            <ul class="list-unstyled contact-list mb-0">
	                                <li>
	                                    <div class="d-flex align-items-center">
	                                        <div class="flex-shrink-0">
	                                            <img src="/resources/chat/assets/images/users/avatar-11.jpg" alt=""
	                                                class="avatar-sm rounded-circle">
	                                        </div>
	...
	<!-- JAVASCRIPT -->
	<script src="/resources/chat/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script src="/resources/chat/assets/libs/simplebar/simplebar.min.js"></script>
	<script src="/resources/chat/assets/libs/node-waves/waves.min.js"></script>
	
	<!-- Modern colorpicker bundle -->
	<script src="/resources/chat/assets/libs/@simonwep/pickr/pickr.min.js"></script>
	
	<!-- glightbox js -->
	<script src="/resources/chat/assets/libs/glightbox/js/glightbox.min.js"></script>
	
	<!-- Swiper JS -->
	<script src="/resources/chat/assets/libs/swiper/swiper-bundle.min.js"></script>
	
	<!-- fg-emoji-picker JS -->
	<script src="/resources/chat/assets/libs/fg-emoji-picker/fgEmojiPicker.js"></script>
