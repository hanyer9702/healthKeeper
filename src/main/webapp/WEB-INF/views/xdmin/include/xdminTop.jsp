...
<link rel="shortcut icon"
	href="/resources/xdmin/img/icons/icon-48x48.png" />
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item"><a class="sidebar-link"
						href="/xdmin/memberList"> <i class="align-middle"
					...
					<ul class="navbar-nav navbar-align">
							...
							<div
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="/resources/xdmin/img/avatars/avatar-5.jpg"
										...
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="/resources/xdmin/img/avatars/avatar-2.jpg"
													class="avatar img-fluid rounded-circle"
													alt="William Harris">
											</div>
											<div class="col-10 ps-2">
										...
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="/resources/xdmin/img/avatars/avatar-4.jpg"
													class="avatar img-fluid rounded-circle"
													alt="Christina Mason">
											</div>
											<div class="col-10 ps-2">
										...
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="/resources/xdmin/img/avatars/avatar-3.jpg"
													class="avatar img-fluid rounded-circle"
													alt="Sharon Lessman">
											</div>
											<div class="col-10 ps-2">
						...
						<li class="nav-item dropdown"><a
							...
							href="#" data-bs-toggle="dropdown"> <img
								src="/resources/xdmin/img/avatars/avatar.jpg"
