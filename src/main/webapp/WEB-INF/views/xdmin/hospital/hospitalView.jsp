...
<main class="content">
	<div class="container-fluid p-0">
		...
		<div class="mb-3">
			<h1 class="h3 d-inline align-middle">데이터 상세</h1>
		</div>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<div>
							<button type="button" class="btn btn-warning" onclick="location.href='/xdmin/dataEdit'">수정</button>
							<button type="button" class="btn btn-danger" onclick="location.href='/xdmin/dataList'">삭제</button>
							<button type="button" class="btn btn-success"
								onclick="location.href='/xdmin/dataList'">목록</button>
						</div>
					</div>
				</div>
			</div>
