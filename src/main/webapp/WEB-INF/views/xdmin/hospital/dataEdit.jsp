...
<main class="content">
	<div class="container-fluid p-0">
		...
		<div class="mb-3">
			<h1 class="h3 d-inline align-middle">데이터 수정</h1>
		</div>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<div>
							<button type="button" class="btn btn-success"
								onclick="location.href='/xdmin/dataView'">확인</button>
							<button type="button" class="btn btn-danger" onclick="location.href='/xdmin/dataView'">취소</button>
						</div>
					</div>
				</div>
			</div>
